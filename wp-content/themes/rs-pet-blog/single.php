				...
				<div class="d-flex single-post-navigation justify-content-between">
					<?php if (get_previous_post_link()): ?>
						<div class="previous-post">
							<div class="postarrow"><i class="fa fa-long-arrow-left"></i><?php echo esc_html_e( 'Прошлая', 'rs-pet-blog' ); ?></div>
					...
					?>
					<div class="next-post">
						<div class="postarrow"><?php echo esc_html_e( 'Следующая', 'rs-pet-blog' ); ?><i class="fa fa-long-arrow-right"></i></div>
